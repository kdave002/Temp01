...
- 2026-03-02: Added optional in-memory per-client rate limiting for protected POST endpoints with configurable window + threshold (`RATE_LIMIT_WINDOW_SECONDS`, `RATE_LIMIT_REQUESTS`), safe 429 envelope with request correlation, docs updates, and regression tests. [DONE @ 2026-03-02T04:25:00Z UTC]
- 2026-03-02: Added rate-limit introspection headers (`X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset`) on protected POST responses, and ensured 429 responses also expose the same headers plus `Retry-After`; extended tests accordingly. [DONE @ 2026-03-02T05:58:00Z UTC]
...
- 2026-03-02: Added `Retry-After` response header on rate-limit (`429`) responses while preserving `X-Request-ID`, improving client backoff behavior and operator triage. [DONE @ 2026-03-02T05:23:00Z UTC]
